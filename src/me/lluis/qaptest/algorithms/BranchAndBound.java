...
public class BranchAndBound {
    ...
    private void recursive_tree_exploration(int currentCost, int currentSize, int[] currentAssigment, boolean[] alreadyInAssignment) {
        if (currentSize == n) {
            ...
            for (int i = 0; i < n; ++i) {
                ...
                recursive_tree_exploration(0, 1, currentAssigment, alreadyInAssignment);
            ...
            if (lowerBoundEvaluated && lowerBound > currentBestCost) {
                ...
                for (int i = 0; i < n; ++i) {
                    if (!alreadyInAssignment[i]) {
                        ...
                        recursive_tree_exploration(currentCost + costIncrease, currentSize + 1, currentAssigment, alreadyInAssignment);
